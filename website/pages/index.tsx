...
import IndexInformationSection from '../components/index/IndexInformationSection';
import useAnimations from '../hooks/index/useAnimations';
import styles from '../styles/Home.module.scss';

const DynamicMeetingsTable = dynamic(
  () => import('../components/index/IndexMeetingsTable'),
  { ssr: false }
);
